...
MINITEST(utc0_ExpectedConstrtuct, ut1_castd_expected)
...
MINITEST(utc1_PartialExpectedConstrtuct, ut1_castd_expected)
...
MINITEST(utc1_BoolErrorConstrtuct, ut1_castd_expected)
